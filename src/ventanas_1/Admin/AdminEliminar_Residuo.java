 ...
 * @author 58424
 */
public class AdminEliminar_Residuo extends javax.swing.JPanel {

    /**
     * Creates new form AdminEliminar_Residuo
     */
    public AdminEliminar_Residuo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Se encuentra en el panel de eliminar información. Área de los Residuos.");

        jLabel1.setFont(new java.awt.Font("Roboto", 2, 14)); // NOI18N
        jLabel1.setText("A continuación rellene la información del productor que desea Eliminar.");

        jTextField2.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(102, 102, 102));
        jTextField2.setText("ID_Residuo");
